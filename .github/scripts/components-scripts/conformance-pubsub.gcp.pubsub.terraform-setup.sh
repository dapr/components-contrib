...
terraform plan -no-color -var="GCP_PROJECT_ID=$GCP_PROJECT_ID" -var="UNIQUE_ID=$UNIQUE_ID" -var="TIMESTAMP=$CURRENT_TIME"
terraform apply -auto-approve -var="GCP_PROJECT_ID=$GCP_PROJECT_ID" -var="UNIQUE_ID=$UNIQUE_ID" -var="TIMESTAMP=$CURRENT_TIME"

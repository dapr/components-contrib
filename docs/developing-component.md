...
| Conversation | [components-contrib/conversation](https://github.com/dapr/components-contrib/tree/master/conversation) | [Echo](https://github.com/dapr/components-contrib/tree/master/conversation/echo) | [concept](https://docs.dapr.io/developing-applications/building-blocks/conversation/conversation-overview/), [api spec](https://docs.dapr.io/reference/api/conversation_api/) |
| Cryptography | [components-contrib/crypto](https://github.com/dapr/components-contrib/tree/master/crypto) | [Local Storage](https://github.com/dapr/components-contrib/tree/master/crypto/localstorage) | [concept](https://docs.dapr.io/developing-applications/building-blocks/cryptography/cryptography-overview/), [api spec](https://docs.dapr.io/reference/api/cryptography_api/) |
| Distributed Lock | [components-contrib/lock](https://github.com/dapr/components-contrib/tree/master/lock) | [Redis](https://github.com/dapr/components-contrib/tree/master/lock/redis) | [concept](https://docs.dapr.io/developing-applications/building-blocks/distributed-lock/distributed-lock-api-overview/), [api spec](https://docs.dapr.io/reference/api/lock_api/) |
...
make lint
```
> ⚠️ **Warning**: You may run into version incompatibilities between the installed Go version and the golangci-lint version and see the following error:
>   ```

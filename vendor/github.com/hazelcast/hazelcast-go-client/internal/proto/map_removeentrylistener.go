...
// MapRemoveEntryListenerEncodeRequest creates and encodes a client message
...
// func MapRemoveEntryListenerDecodeResponse(clientMessage *ClientMessage) , this message has no parameters to decode.
